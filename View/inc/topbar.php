	...
	<nav id="cssColor">
		<div class="container">
			<div class="nav-wrapper">
				...
				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo">Boutique Livre</a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<li class="<?php echo ($_GET['a']=="chapters")?"active" : ""; ?>"><a href="<?=ROOT_URL?>blog_chapters.html">Livres</a></li>
